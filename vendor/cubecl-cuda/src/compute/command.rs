...
impl<'a> Command<'a> {
    ...
    pub fn kernel(
        ...
        // Skip the drop-queue flush while a CUDA-graph capture is in progress: the flush
        // does a BLOCKING fence sync to reclaim freed memory, which would invalidate the
