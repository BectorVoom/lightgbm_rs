...
Last activity: 2026-06-08 - Completed quick task 260608-mc5: merge CPU+GPU split kernel (shared #[cube]) + fused per-leaf GPU launch (gfx1100 3.4–3.6×); CPU kept on native (cubecl-cpu slower)
