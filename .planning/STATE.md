...
Last activity: 2026-06-08 - Completed quick task 260608-p90: device-resident histogram pool (build+subtract+scan resident, eligibility-gated) — correct (resident==host trees GREEN) but mixed perf (medium +10%, large flat, small -13% regression)
