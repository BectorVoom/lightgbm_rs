...
Last activity: 2026-06-08 - Completed quick task 260608-t3t: fused build+fix+compact+scan kernel (3 launches→1, BIT-EXACT) — but net flat/worse (sequential f64 build loses parallelism); gated OFF by default. GPU micro-fusion thread at diminishing returns.
