...
Last activity: 2026-06-08 - Completed quick task 260608-s2b: widen-fold (build 3→2 launches, bit-exact) + data-driven size-gate (RESIDENT_MIN_NUM_DATA=12000) — small −13% regression eliminated. Profile found GPU is launch-bound (~205/tree), pool already hits.
