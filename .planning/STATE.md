...
Last activity: 2026-06-08 - Completed quick task 260608-nn7: device-resident binned dataset (L1) — GPU host-device round-trip elimination (medium ~10-15%); L3 on-GPU FixHistogram deferred
